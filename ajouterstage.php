...
if(isset($_POST['valider'])&& isset($_FILES['image']))
{
    ...
    $content = mysqli_real_escape_string($conx, $content);
      //verifier si le code trouve dans la base 
       $req="INSERT into stage values (null,'$date_creation', '$date_modification','$titre','$sujet','$nom_encadrent','$date_deb','$date_fin','$duree','".$_FILES['image']['name']."','$content')";
    ...
    <div class="main-container">
        <div  class="row1 row"> 
            ...
            <path d="m9.708 6.075-3.024.379-.108.502.595.108c.387.093.464.232.38.619l-.975 4.577c-.255 1.183.14 1.74 1.067 1.74.72 0 1.554-.332 1.933-.789l.116-.549c-.263.232-.65.325-.905.325-.363 0-.494-.255-.402-.704l1.323-6.208Zm.091-2.755a1.32 1.32 0 1 1-2.64 0 1.32 1.32 0 0 1 2.64 0Z"/>
                      ...
                      <form name="f" enctype="multipart/form-data" onsubmit="return validerDates()" method="POST" style="max-width:930px;margin-left:200px;"class="card">
        ...
        <p style="margin-left:70px;color:red;"id="result"></p>
        ...
        <div class="row g-3">
            ...
            <input type="text" class=" input-ajout form-control" name="titre" placeholder="Titre de Stgae" required>
            <label style="margin-left:30px; color:blue;font-size:18px;">Date début stage:</label>   
            <input type="date" class="input-ajout form-control" name="datedeb" id="start-date" onchange="validateDateRange()"  placeholder="Date début stage"  required>
            <label style="margin-left:30px; color:blue;font-size:18px;">Date fin stage:</label>
            <input type="date" class="input-ajout form-control" name="datefin" id="end-date" onchange="validateDateRange()" placeholder="Date fin stage" required>
            <label style="margin-left:30px; color:blue;font-size:18px;">Duréé du stage :</label>
            <input type="text" class=" input-ajout form-control" name="duree" placeholder="Duréé du stage" required>
        </div>
        <div class="col">
           <label style="margin-left:30px; color:blue;font-size:18px;">Sujet de stage:</label>
            <textarea  class="input-ajout form-control" name="sujet"id="sujet"  placeholder="sujet de stage" required></textarea>
            <label style="margin-left:30px; color:blue;font-size:18px;">Nom de l'encadrent:</label>
            <input type="text" class="form-control input-ajout " name="encadrent"  placeholder="Nom de l'encadrent" required>
