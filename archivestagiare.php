...
$req2="SELECT * from affectation a join demande d on(a.id_demande=d.id_demande) join stagiare s on(s.id_stagiare=d.id_stagiare)where status='supprimer' order by id_affectation desc limit $start,$rows_per_page";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="main-container">
        <div  class="row1 row"> 
            ...
            </svg>Liste d'archive des stagiares:</i></h4>
