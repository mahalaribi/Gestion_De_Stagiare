...
<body>
    <div class=" heder1 header">
        <div style="margin-right:12px;" class="d-flex justify-content-between">
            <div>
           <a href="dashboard-etudiant.php"> <img class="image-stage "  src="img/logo2.png"></a>
            </div>
            
            <div style="padding-top:5px;">
                <label style="color:white;margin-top:px;font-size: 25px;">
                <?php echo "$row[nom] $row[prenom]";?>
              </label>
              <a href='imageetudiant.php?code_u=<?= $row['id_stagiare'];?>'> <img class="image-profil rounded-circle"  src="<?= $row['image'];?>"></a>
