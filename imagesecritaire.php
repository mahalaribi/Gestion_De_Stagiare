...
$req2="UPDATE user set  prenom='$prenom', date_modification=' $date_modif' , adress='$adresse' , nom='$nom',ville='$ville',num='$num',image='".$_FILES['image']['name']."',content='$content' where id_user=' $id_user'";
$res=$conx->query($req2);
