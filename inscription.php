...
if(isset($_POST['valide'])&&isset($_FILES['image']))
{
  ...
  $req1=mysqli_query($conx,"SELECT email from stagiare where email='$mail'");
    ...
    {
     $msg=  ' <div style="margin-left:100px;margin-top:5px;max-width:400px;" class="alert alert-danger" role="alert">
     Email déja saisire tapez un autre!
   </div>';
    }
    elseif($pass!=$confirmmdp)
    {
      $msg=  ' <div style="margin-left:100px;margin-top:15px;max-width:400px;" class="alert alert-danger" role="alert">
    ...
    else 
    {
      ...
      $req=mysqli_query($conx,"INSERT into stagiare (nom,prenom,ville,num,email,pwd,cpwd,image,content,role,date_creation,date_modification,adress)
        values
        ('$nom','$prenom','$ville','$num ','$mail','$pass',' $confirmmdp','".$_FILES['image']['name']."','$content','stagiare',' $date_creation',' $date_modification','$adresse')");
...
<form name="f" enctype="multipart/form-data" method="POST">
  ...
  <DIV>
    ...
    <img src="img/inscri.jpg" class="rounded-circle"style="max-width:500px;max-height:500px;margin-top:px;margin-left:150px;">
  </DIV>
  </td>
  <td>
...
<div class="card-header text-center" >
  ...
  <div class=" div-input2">
    <input type="number" maxlength="8" class="form-control" name="num" placeholder="numero telephone" aria-label="num"required>
  </div>
  <div class="div-input2">
