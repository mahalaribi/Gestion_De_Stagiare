...
<body>
    ...
    <div class="main-container">
        <div  class="row1 row"> 
            ...
            </svg>Liste des absences secritaire:</i></h4>
            
            <a style="color:black;"href="marquer_absence.php"><i style="margin-left:50px;"class="fa fa-plus-square" aria-hidden="true"></i></a>
            <table style="max-width:1300px; margin-left:50px;" class="table">
                    ...
                    <?php include("connexion.php");
                           $req2="SELECT count(*) as nombre_absence,u.nom,u.prenom ,f.id_secritaire ,f.id_absence,u.image from absence_secrittaire f join user  u on u.id_user=f.id_secritaire where u.role='secritaire' group by f.id_secritaire " ;
                            $res = $conx->query($req2);
                            if(!$res)
                            {
                    ...
                    <tbody>
                    <tr> 
                            <td><img style='max-width:100px;max-height:100px;' src='$row[5]'></td>
                           <td style='padding-top:40px;' >$row[3]</td>
                            <td style='padding-top:40px;'>$row[1]</td>
                            <td style='padding-top:40px;'>$row[2]</td>
                            <td style='padding-top:40px;'>$row[0]</td>
                            <td style='padding-top:40px;'> 
                            <a  href='suprimerabsence.php?code_ab=$row[4]'><i style='color:red;' class='bi bi-trash3-fill'><svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' class='bi bi-trash3-fill' viewBox='0 0 16 16'>
