...
$req2="SELECT * from stage  order by id_stage desc limit $start,$rows_per_page";
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div  class="row1 row"> 
            ...
            <path d="m9.708 6.075-3.024.379-.108.502.595.108c.387.093.464.232.38.619l-.975 4.577c-.255 1.183.14 1.74 1.067 1.74.72 0 1.554-.332 1.933-.789l.116-.549c-.263.232-.65.325-.905.325-.363 0-.494-.255-.402-.704l1.323-6.208Zm.091-2.755a1.32 1.32 0 1 1-2.64 0 1.32 1.32 0 0 1 2.64 0Z"/>
                     ...
                     <table class="table caption-top ">
                        <caption style=""><a href="ajouterstage.php"><i class="bi bi-plus-lg"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                       <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                        </svg></i></a></caption>
                        <thead>
                        <tr>
                           <th scope="col">Image</th>
                            <th scope="col">Code stage</th>
                            <th scope="col">Titre</th>
                            <th scope="col">Sujet</th>
                            <th scope="col">Nom encadrent(e)</th>
                        ...
                        <?php include("connexion.php");
                            ...
                            <tr>
                                ...
                                <td style='padding-top:40px;'>$row[id_stage]</td>
                                <td style='padding-top:40px;'>$row[titre]</td>
                                <td style='padding-top:40px;'>$row[sujet]</td>
                                <td style='padding-top:40px;'>$row[nom_encadrent]</td>
                                <td style='padding-top:40px;'>$row[date_debut]</td>
                                <td style='padding-top:40px;'>$row[date_fin]</td>
                                <td style='padding-top:40px;'>$row[duree]</td>
                                <td style='padding-top:40px;'>
                                <a href='supprimer-stage.php?code_stage=$row[id_stage]'><i style='color:red;' class='bi bi-trash3-fill'><svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' class='bi bi-trash3-fill' viewBox='0 0 16 16'>
                                <path d='M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z'/>
                              </svg></i></a>
                              <a href='modifier-stage.php?code_stage=$row[id_stage]'><i style='color:blue;'class='bi bi-pencil-square'><svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
