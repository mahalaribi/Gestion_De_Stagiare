                     ...
                     <table class="table caption-top ">
                        ...
                        <?php include("connexion.php");
                            ...
                            <tr>
                                ...
                                <td style='padding-top:40px;'><a href='archive-action.php?code_d=$row[id_affectation]'><i style='color:red;' class='bi bi-trash3-fill'><svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' class='bi bi-trash3-fill' viewBox='0 0 16 16'>
