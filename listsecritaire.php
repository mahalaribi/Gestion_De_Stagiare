...
$req2="SELECT * from user where role='secritaire' order by id_user desc limit $start,$rows_per_page";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="main-container">
        <div  class="row1 row"> 
            ...
            </svg>Liste des sécritaires :</i></h4>
           ...
           <div style="margin-bottom:px;"id="searchresult">
                     <table class="table caption-top ">
                        <caption style="margin-left:94%;"><a href="ajoutersecritaire.php"><i class="bi bi-plus-lg"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                       <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                        </svg></i></a></caption>
                        <thead>
                            <tr>
                            <th scope="col">Image</th>
                            <th scope="col">Code_secritaire</th>
                                <th scope="col">Nom</th>
                        ...
                        <?php include("connexion.php");
                            ...
                            <tr>
                                ...
                                <td style='padding-top:40px;'>$row[id_user]</td>
                                ...
                                <td style='padding-top:40px;'>$row[role]</td>
                                <td style='padding-top:40px;'>$row[role]</td>
                                <td style='padding-top:40px;'><a href='supprimer-secritaire.php?code_sec=$row[id_user]'><i style='color:red;' class='bi bi-trash3-fill'><svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' class='bi bi-trash3-fill' viewBox='0 0 16 16'>
