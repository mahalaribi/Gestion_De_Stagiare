...
if(isset($_POST['valider']))
{
   ...
   $id=$_POST['code_sec'];
       $req="INSERT into absence_secrittaire values (null,'$date_creation', '$date_modification','$date_deb','$date_fin','$justification','$id','$hdeb','$hfin')";
...
<head>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
       <script src="photosecritaire.js"></script>
       <style>
         .input-ajout
        {
            margin:9px;
...
<body>
    ...
    <div class="main-container">
        <div  class="row1 row"> 
            ...
            </svg>  Marquer absence secritaire :</i></h4>
         ...
         <div class="row g-3">
            <div class="col">
            <label style="margin-left:30px; color:blue;font-size:18px;">Nom secritaire:</label>
            <select class="input-ajout form-select" id="mySelect" name="code_sec" placeholder="Nom secritaire:" >
                    <option placeholder="choisir secritaire"selected> choisir secritaire</option>
                    <?php 
                    $req=mysqli_query($conx,"SELECT * from user where role='secritaire'");
                    ...
                    else
                    {
                      ...
                      {?>
                        <option value=<?php echo"$row[id_user]"?>><?=$row['nom']," ",$row['prenom'] ;?></option>
                     <?php
                      }
                    }
                    ?>                       
