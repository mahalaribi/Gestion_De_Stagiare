...
$id_stagiare=$row['id_stagiare'];
    ...
    $req2="UPDATE stagiare set pwd='$new_mdp', date_modification='$date_modif',cpwd='$confirm_mdp' where id_stagiare=' $id_stagiare'";
    $res=$conx->query($req2);
    header("location:profil.php");
     }

}
$req="SELECT * from stagiare where id_stagiare='".$_SESSION["id"]."' "  ;
$res=$conx->query($req);
if(!$res)
{
           ...
           <div class="row m-3" >
            <div class="card  text-center col-md-4 "  style="margin-left:40px;margin-top:30px;">
                ...
                <div  style="margin-top:15px;">
                    <input type="hidden" style="margin-top:15px;margin-bottom:15px;" value='<?= $id_stagiare;?>'  name="id_stagiare" class="form-control" placeholder="id_stagiare" id="inputPassword4" required>
