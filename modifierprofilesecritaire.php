...
{
header("locations:profilsecritaire.php");
exit;
}
$id_user=$_GET['code_u'];
...
$req2="UPDATE user set  prenom='$prenom', date_modification=' $date_modif' , adress='$adresse' , nom='$nom',ville='$ville',num='$num' where id_user=' $id_user'";
$res=$conx->query($req2);
header("location:profilsecritaire.php");
}
 ?>
 <!DOCTYPE html>
<html lang="en">
